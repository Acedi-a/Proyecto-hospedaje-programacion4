...
  return (
    <div className="p-6 bg-gray-50" ref={reportRef}> {/* Asignar la referencia aquí */}
...
          )}
          ...
          <button
            onClick={generatePdf}
            className="px-4 py-2 bg-red-600 text-white font-semibold rounded-md shadow hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-opacity-50 self-end md:self-auto"
          >
            Descargar PDF
          </button>
        </div>
...
              {/* El botón de descarga se podría poner aquí también si prefieres */}
            </div>
